...
class Entity(models.Model):
    ...
    Links_to_shops = models.ForeignKey(Links_to_shops, on_delete=models.RESTRICT, null=True)
    Entity_Category = models.ForeignKey(Entity_Category, on_delete=models.RESTRICT, null=True)
